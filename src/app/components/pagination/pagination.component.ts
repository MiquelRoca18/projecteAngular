...
import { PagiantonService } from '../../services/pagianton.service';
...
export class PaginationComponent implements OnInit {
  constructor(private http: HttpClient, private paginacionService: PagiantonService, private router: Router) { }
